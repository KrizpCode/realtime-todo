  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} role="form" className="my-4 flex">
      <input
        ...
        className={`grow rounded-l-md border-y-2 border-l-2 bg-gray-100 px-3 py-1 font-medium outline-0 hover:bg-gray-200 ${errors?.['name']?.message ? 'border-red-500' : 'border-gray-100 hover:border-gray-200 focus:border-blue-500'}`}
      />
      <button
        type="submit"
